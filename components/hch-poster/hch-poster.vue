<template>
	...
	<view class="canvas_box" :hidden="canvasFlag">
		...
		<icon type="cancel" class="canvas_close_btn" size="40" @click="canvasCancelEvn()" @tap="canvasCancelEvn()" color="transparent"/><!-- 关闭 -->
		<view class="button-wrapper"><!-- 保存海报按钮 -->
			<view class="save_btn" @tap="saveCanvasImage"></view>
		</view>
